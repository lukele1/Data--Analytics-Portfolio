...
-- Author: Phuc Le
-- Description: Cleaning and standardizing World Life Expectancy dataset
-- Dataset: 2,941 records across 193 countries (2007-2022)
...
-- Summary of changes:
-- 1. Removed 3 duplicate Country/Year combinations
-- 2. Filled blank Status values (Developing/Developed) based on country's other records
-- 3. Filled blank Life Expectancy values using average of previous and next year
-- 
-- Techniques used:
